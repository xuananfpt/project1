                                        ...
                                        <tr>
                                            ...
                                            <td class="clearfix">
                                                ...
                                                <ul class="list-operation fl-right">
                                                    <li><a href="?mod=page&action=editPage&id=<?php echo $item['page_id'] ?>" title="Sửa" class="edit"><i class="fa fa-pencil"
                                                                aria-hidden="true"></i></a></li>
                                                    <li><a href="?mod=page&action=deletePage&id=<?php echo $item['page_id'] ?>" title="Xóa" class="delete"><i class="fa fa-trash"
                                                                aria-hidden="true"></i></a></li>
                                                </ul>
                                            </td>
